<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="mailto:perfumestore@gmail.com"><i class="fas fa-envelope"></i> perfumestore@gmail.com</a>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>Perfume store</span> | all rights reserved!</div>
